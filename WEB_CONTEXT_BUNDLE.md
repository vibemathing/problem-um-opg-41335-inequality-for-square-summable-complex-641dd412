...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-41335-inequality-for-square-summable-complex-641dd412-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-41335"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-41335-inequality-for-square-summable-complex-641dd412-v1",
      "problem_contract_sha256": "64b35c9a3bd3e362f410dd684de64a277e03584ff0bd2e399d42f6d48ede2851",
      "problem_id": "problem:um-opg-41335-inequality-for-square-summable-complex-641dd412",
      "route_id": "route:um-opg-41335-inequality-for-square-summable-complex-641dd412-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-41335-inequality-for-square-summable-complex-641dd412-source-fidelity-01",
      "graph_id": "graph:um-opg-41335-inequality-for-square-summable-complex-641dd412-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-41335-inequality-for-square-summable-complex-641dd412-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-41335-inequality-for-square-summable-complex-641dd412-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture For all $\\alpha=(\\alpha_1,\\alpha_2,\\ldots)\\in l_2(\\cal{C})$ the following inequality holds $$\\sum_{n\\geq 1}|\\alpha_n|^2\\geq \\frac{6}{\\pi^2}\\sum_{k\\geq0}\\bigg| \\sum_{l\\geq0}\\frac{1}{l+1}\\alpha_{2^k(2l+1)}\\bigg|^2$$"
          },
          "statement_sha256": "2883c5e81900e06d1914fa4c73da68c804570a09993d99854b4da7775c11f9e1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-41335-inequality-for-square-summable-complex-641dd412-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-41335-inequality-for-square-summable-complex-641dd412-root",
      "route_id": "route:um-opg-41335-inequality-for-square-summable-complex-641dd412-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "domain": {
      "description": "Source-native Analysis problem. Mathematical objects and notation are exactly those explicitly present in the frozen source statement.",
      "objects": [
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-41335-59d5e637fc61",
        "url": "https://www.unsolvedmath.com/problems/OPG-41335"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
